    ...
    modalTwoOpen ?  
      ...
      >
        <Container>
          ...
          <ButtonContainer>
            <A href="https://github.com/reactIsland/project-frontend" target="_blank">to frontend github</A>
            <A href="https://github.com/reactIsland/Unit3-Project-Backend" target="_blank">to backend github</A>
          </ButtonContainer>
          <div>
